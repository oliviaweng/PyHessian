...
class hessian():
    ...
    def __init__(self, model, criterion, layers, data=None, dataloader=None, cuda=True):
        ...
        if not self.full_dataset:
            ...
            targets = np.argmax(self.targets.detach().numpy(), axis=1)
    ...
    def eigenvalues(self, maxIter=100, tol=1e-3, top_n=1):
        ...
        for layer in self.gradsL.keys():
            ...
            while computed_dim < top_n:
                ...
                computed_dim += 1
            eigenvalueL[layer] = eigenvalues
            eigenvectorL[layer] = eigenvectors

        return eigenvalues, eigenvectors, eigenvalueL, eigenvectorL
